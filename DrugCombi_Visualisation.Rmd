...
outdir <- "out"
knitr::opts_chunk$set(dev = c("png", "pdf"), fig.path = paste0("figuresViz", today, "/"))
```
...
Loaded dataframe from MarinaCombiDataAfterQC_:
...
- 'SetUpLost':  contains info about plate structure for the screens
...
- 'df4anaAvreplRemOutl': df4anaAvrepl, filtering out values above 1.4
