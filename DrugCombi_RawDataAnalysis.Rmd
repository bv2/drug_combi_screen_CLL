...
load("../Analysis/DrugMetaData.RData")
DrugInfoAll <- drugs
rm(drugs)
```
...
DrugInfoCombi <- data.frame(abrv=CombiDrugs, 
                            name=c("DMSO", "Ibrutinib","Ibrutinib",
                                  ...
                                  "Everolimus"),
                            conc=c(NA, 0.1, 1, 1,1,1, NA, NA, 1, 0.01, 0.005,1,1,NA) # info taken from "Versuche-Patienten-Drugs.xlsx",
)
...
```{r}
CompleteDFwoControl<-CompleteDF[CompleteDF$BaseDrugID!="DM",]
```
