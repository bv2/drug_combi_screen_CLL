...
```{r summary_Navitoclax, fig.height = 8 }
ggNavi <- plotSummaryLoewe("Navitoclax")
ggNavi
```

```{r summary_Afatinib, fig.height = 8 }
ggAfa <- plotSummaryLoewe("Afatinib")
ggAfa
```

```{r summary_Venetoclax, fig.height = 8 }
ggVen <- plotSummaryLoewe("Venetoclax")
ggVen
```
