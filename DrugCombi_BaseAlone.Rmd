...
mostCommonMuts <- colSums(dfMuts[,-1]) > 10
mostCommonMuts <- names(mostCommonMuts)[which(mostCommonMuts)]

ggplot(filter(df_pvals_max,mutation %in% mostCommonMuts), aes(x=mean.diff, y=-log10(pval.adj), col=col)) +
